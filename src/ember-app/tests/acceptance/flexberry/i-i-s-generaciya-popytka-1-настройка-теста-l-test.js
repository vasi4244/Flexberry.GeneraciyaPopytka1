...
moduleForAcceptance('[AGAT] Acceptance | i i s generaciya popytka 1 настройка теста l');

test('testing i-i-s-generaciya-popytka-1-настройка-теста-l', function(assert) {
