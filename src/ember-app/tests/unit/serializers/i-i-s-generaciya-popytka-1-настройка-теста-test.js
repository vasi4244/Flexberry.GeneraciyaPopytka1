...
moduleForModel('i-i-s-generaciya-popytka-1-настройка-теста', 'Unit | Serializer | i-i-s-generaciya-popytka-1-настройка-теста', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-generaciya-popytka-1-настройка-теста',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
