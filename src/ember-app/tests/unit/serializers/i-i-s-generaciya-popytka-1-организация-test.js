...
moduleForModel('i-i-s-generaciya-popytka-1-организация', 'Unit | Serializer | i-i-s-generaciya-popytka-1-организация', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-generaciya-popytka-1-организация',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
