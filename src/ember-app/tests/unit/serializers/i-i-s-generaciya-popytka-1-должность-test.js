...
moduleForModel('i-i-s-generaciya-popytka-1-должность', 'Unit | Serializer | i-i-s-generaciya-popytka-1-должность', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-generaciya-popytka-1-должность',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
